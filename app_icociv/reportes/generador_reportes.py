        ...
        filas.append(
            {
                ...
                "candidato_seleccionado": horizonte_info.get("candidato_seleccionado", ""),
                "estrategia_calendario": horizonte_info.get("estrategia_calendario", ""),
                "modelo_base": horizonte_info.get("modelo_base", ""),
                "fourier_k": horizonte_info.get("fourier_k", ""),
                "fourier_periodo": horizonte_info.get("fourier_periodo", ""),
                "fourier_coef_sin_1": horizonte_info.get("fourier_coef_sin_1", ""),
                "fourier_coef_cos_1": horizonte_info.get("fourier_coef_cos_1", ""),
                "fourier_amplitud": horizonte_info.get("fourier_amplitud", ""),
                "metricas_reportadas": "",
                "estado_horizonte": "",
